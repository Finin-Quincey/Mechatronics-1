%GANTRYMOVESENSORTEST2 Script to make the gantry move in a linear scanning pattern, with smallest
...
x = 20 + floor(((1:40)-1)/2)*1; % 20, 20, 21, 21, 22, 22, ...
y = 10 + (mod(1:40, 4) < 2) * 40; % 10, 50, 50, 10, 10, 50....
